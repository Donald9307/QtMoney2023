...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Records_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Records_t qt_meta_stringdata_Records = {
    {
        QT_MOC_LITERAL(0, 7)   // "Records"
    },
    "Records"
};
...
Q_CONSTINIT static const uint qt_meta_data_Records[] = {
...
Q_CONSTINIT const QMetaObject Records::staticMetaObject = { {
    ...
    qt_meta_stringdata_Records.offsetsAndSizes,
    qt_meta_data_Records,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Records_t,
        // Q_OBJECT / Q_GADGET
